...
4. **Task notes** (PLAN.md, TODO.md) are updated if they exist for this area.
5. **Linear issue** status is current (should be In Progress or In Review).
6. **README** is updated if the change adds a new project or changes how something is run.
